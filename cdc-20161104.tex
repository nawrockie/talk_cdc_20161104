...
\begin{slide}
\begin{center}
\textbf{Next strep: Annotate ``All'' Flaviviruses}

LIST/TABLE OF FLAVIVIRUSES FOR WHICH WE HAVE ANNOTATIONS

columns: name, number of sequences, number of MPs, CDS, errors
