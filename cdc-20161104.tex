...
\begin{slide}
\begin{center}
\includegraphics[width=10in]{figs/pilot-errcode-table-4}
\vfill
\end{center}
\end{slide}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{slide}
\begin{center}
\includegraphics[width=10in]{figs/pilot-errcode-table-4-plus-cdc}
\vfill
\end{center}
\end{slide}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{slide}
\begin{center}
\textbf{Output list of all insertions and deletions}

\includegraphics[width=10in]{figs/hbv-gaps}
...
\begin{itemize}
  \item Correctly classifies 1100 out of 1102 flavivirus seqs
